...
public class KnightMove {
    ...
    public List<NewPosition> listMove(CurrentPosition knight){
        ...
        if (rowCur<7 && colCur<6 && !pieceRepo.existsByRowIdxAndColIdxAndIsWhiteAndChessGame(
                rowCur + 1, colCur + 2, knight.isWhite(), game)
        )
            listMove.add(NewPosition.builder().rowIdx(rowCur+1).colIdx(colCur+2).build());
        if (rowCur<7 && colCur>1 && !pieceRepo.existsByRowIdxAndColIdxAndIsWhiteAndChessGame(
                rowCur + 1, colCur - 2, knight.isWhite(), game
        ))
            listMove.add(NewPosition.builder().rowIdx(rowCur+1).colIdx(colCur-2).build());
        if (rowCur<6 && colCur<7 && !pieceRepo.existsByRowIdxAndColIdxAndIsWhiteAndChessGame(
                rowCur + 2, colCur + 1, knight.isWhite(), game
        ))
            listMove.add(NewPosition.builder().rowIdx(rowCur+2).colIdx(colCur+1).build());
        if (rowCur<6 && colCur>0 && !pieceRepo.existsByRowIdxAndColIdxAndIsWhiteAndChessGame(
                rowCur + 2, colCur - 1, knight.isWhite(), game
        ))
            listMove.add(NewPosition.builder().rowIdx(rowCur+2).colIdx(colCur-1).build());
        if (rowCur>0 && colCur<6 && !pieceRepo.existsByRowIdxAndColIdxAndIsWhiteAndChessGame(
                rowCur - 1, colCur + 2, knight.isWhite(), game
        ))
            listMove.add(NewPosition.builder().rowIdx(rowCur-1).colIdx(colCur+2).build());
        if (rowCur>0 && colCur>1 && !pieceRepo.existsByRowIdxAndColIdxAndIsWhiteAndChessGame(
                rowCur - 1, colCur - 2, knight.isWhite(), game
        ))
            listMove.add(NewPosition.builder().rowIdx(rowCur-1).colIdx(colCur-2).build());
        if (rowCur>1 && colCur<7 && !pieceRepo.existsByRowIdxAndColIdxAndIsWhiteAndChessGame(
                rowCur - 2, colCur + 1, knight.isWhite(), game
        ))
            listMove.add(NewPosition.builder().rowIdx(rowCur-1).colIdx(colCur-2).build());
        if (rowCur>1 && colCur>0 && !pieceRepo.existsByRowIdxAndColIdxAndIsWhiteAndChessGame(
                rowCur - 2, colCur - 1, knight.isWhite(), game
        ))
            listMove.add(NewPosition.builder().rowIdx(rowCur-1).colIdx(colCur-2).build());
        return listMove;
